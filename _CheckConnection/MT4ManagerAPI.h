...
#endif
//+------------------------------------------------------------------+
#define _struct(S) struct S { S() { ZeroMemory(this, sizeof(S)); }
//+------------------------------------------------------------------+
...
_struct(UserRecord)
   ...
   //---
	// {{ Original MT declaration:
//   char              unused[40];                 // for future use
	// Original MT declaration }}
	// {{ TTS-specific declaration:
   char              unused[28];                 // for future use
   char              currency[12];               // deposit currency - for TTS only!!!
	// TTS-specific declaration }}
